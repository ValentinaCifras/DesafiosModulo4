...
class Basica(Membresia):
    ...
    def __init__(self,correo_suscriptor:str, numero_tarjera:str):
        super().__init__(correo_suscriptor,numero_tarjera)
...
class Pro(Familiar, SinConexion):
    ...
    def cambiar_suscripcion(self, nueva_membresia:int):
        if nueva_membresia not in [1,2,3]:
            ...
            return self._crear_nueva_membresia
